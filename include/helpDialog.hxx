...
private:
         ...
         [[nodiscard]] PushButton * getNewNextButton(QWidget * parentWidget) noexcept;
         [[nodiscard]] PushButton * getNewCloseButton(QWidget * parentWidget) noexcept;
         [[nodiscard]] PushButton * getNewPrevButton(QWidget * parentWidget) noexcept;
         [[nodiscard]] QLabel * getNewLabel(QWidget * parentWidget) const noexcept;
